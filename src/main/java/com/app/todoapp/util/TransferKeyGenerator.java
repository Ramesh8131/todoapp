...
//https://github.com/ExampleDriven/spring-boot-cache-example/blob/master/src/main/java/org/exampledriven/springcache/service/BankService.java
    @Override
...
//                    ||"taskid".equals(parameter.getName())
                )
            ) {
                return params[i];
            }
